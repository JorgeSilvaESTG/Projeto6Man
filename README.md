...
Script personalizado para HaxBall, desenvolvido para criar e gerir uma experiência de jogo no formato 6-Man, com sistemas de administração, estatísticas de jogadores, ranks, gestão de chat e um mapa personalizado.
